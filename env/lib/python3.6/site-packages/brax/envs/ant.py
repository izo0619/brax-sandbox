...
_SYSTEM_CONFIG = """
  ...
  joints {
    name: "hip_1"
    parent_offset { x: 0.15 y: 0.2 }
    child_offset { x: -0.13 y: -0.18 }
    parent: "$ Torso"
    child: "Aux 1"
  ...
  joints {
    name: "ankle_1"
    parent_offset { x: 0.13 y: 0.18 }
    child_offset { x: -0.21 y: -0.28 }
    parent: "Aux 1"
    child: "$ Body 4"
    rotation: { z: 135 }
    angle_limit {
  ...
  joints {
    name: "hip_3"
    parent_offset { x: -0.23 y: -0.07 }
    child_offset { x: 0.21 y: 0.07 }
    parent: "$ Torso"
    child: "Aux 3"
    rotation { y: -90 }
    angle_limit { min: -30.0 max: 30.0 }
  ...
  joints {
    name: "hip_4"
    parent_offset { x: 0 y: -0.25 }
    child_offset { x: 0 y: 0.22 }
    parent: "$ Torso"
    child: "Aux 4"
    rotation { y: -90}
    angle_limit { min: -30.0 max: 30.0 }
  ...
  joints {
    name: "ankle_4"
    parent_offset { x: 0 y: -0.22 }
    child_offset { x: 0 y: 0.36 }
    parent: "Aux 4"
    child: "$ Body 13"
    rotation { z: 45 }
  ...
  joints {
    name: "hip_5"
    parent_offset { x: 0.24 y: -0.08 }
    child_offset { x: -0.2 y: 0.07 }
    parent: "$ Torso"
    child: "Aux 5"
    rotation { y: -90}
    angle_limit { min: -30.0 max: 30.0 }
  ...
  joints {
    name: "ankle_5"
    parent_offset { x: 0.2 y: -0.07 }
    child_offset { x: -0.34 y: 0.11 }
    parent: "Aux 5"
    child: "$ Body 14"
    rotation { z: 45 }
    angle_limit { min: 30.0 max: 70.0 }
